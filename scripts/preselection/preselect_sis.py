...
from dfm_pipeline.preselection.selectors import run_sis
...
def main():
    ...
    ap.add_argument("--write_panel", action="store_true")  # kept for CLI parity (run_sis writes anyway)
    args = ap.parse_args()
    ...
    run_sis(panel, tag,
            tau=args.tau_sis, top_n=args.top_n,
